pub mod berendsen {
    use crate::lennard_jones_simulations::compute_pressure_particles;
    ...
    pub fn apply_barostat_berendsen_particles(
        ...
        let current_pressure = compute_pressure_particle(particles, *box_length);

        let scale = 1.0 - (dt / tau_p) * compressability * (target_pressure - current_presure);
